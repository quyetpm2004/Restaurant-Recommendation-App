      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="text-center bg-white rounded-lg p-4 shadow-sm border-2 border-gray-200">
                      <div className={`text-4xl ${getScoreColor(score.score)}`}>
                        {score.score}%
                      </div>
                  ...
                  {/* Action Button */}
                  <Link to={`/restaurant/${restaurant.id}`} state={{ criteria }}>
                    <Button type="button" className="w-full md:w-auto bg-orange-500 hover:bg-orange-600 text-white">
        ...
        <div className="mt-8 bg-white/70 rounded-xl p-6">
          <p className="text-gray-600 text-sm">
            <span className="text-orange-600">💡 Mẹo:</span> Độ phù hợp được tính dựa trên
            ngân sách, sức chứa, món ăn và tiện ích. Nhà hàng có độ phù hợp cao nhất sẽ đáp
            ứng tốt nhất nhu cầu của bạn.
          </p>
        </div>
      </div>
    </div>
